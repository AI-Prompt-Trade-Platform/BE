...
public class WishlistController {
    ...
    public ResponseEntity<Void> addPromptToWishlist(
        ...
        wishlistService.addPromptToWishlist(auth0Id, promptId);
    ...
    public ResponseEntity<Void> removePromptFromWishlist(
        ...
        wishlistService.removePromptFromWishlist(auth0Id, promptId);
    ...
    public ResponseEntity<PageResponseDto<PromptSummaryDto>> getUserWishlist(
        ...
        PageResponseDto<PromptSummaryDto> wishlist = wishlistService.getUserWishlist(auth0Id, pageable);
    ...
    public ResponseEntity<Boolean> isPromptInWishlist(
        ...
        boolean isInWishlist = wishlistService.isPromptInWishlist(auth0Id, promptId);
